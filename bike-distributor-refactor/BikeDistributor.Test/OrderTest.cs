...
namespace BikeDistributor.Test
{
    public class OrderTest
    {
        ...
        public void ReceiptOneDefy()
        {
            ...
            Assert.Equal(ResultStatementOneDefy, order.Receipt(Data.Discounts).Replace(Environment.NewLine, " "));
        }
        ...
        public void ReceiptOneElite()
        {
            ...
            Assert.Equal(ResultStatementOneElite, order.Receipt(Data.Discounts).Replace(Environment.NewLine, " "));
        }
        ...
        public void ReceiptOneDuraAce()
        {
            ...
            Assert.Equal(ResultStatementOneDuraAce, order.Receipt(Data.Discounts).Replace(Environment.NewLine, " "));
        }
        ...
        public void HtmlReceiptOneDefy()
        {
            ...
            order.AddLine(new Line(Data.Bikes.Defy, 1));
            Assert.Equal(HtmlResultStatementOneDefy, order.HtmlReceipt(Data.Discounts).Replace(Environment.NewLine, ""));
        }
        ...
        public void HtmlReceiptOneElite()
        {
            ...
            order.AddLine(new Line(Data.Bikes.Elite, 1));
            Assert.Equal(HtmlResultStatementOneElite, order.HtmlReceipt(Data.Discounts).Replace(Environment.NewLine, ""));
        }
        ...
        public void HtmlReceiptOneDuraAce()
        {
            ...
            order.AddLine(new Line(Data.Bikes.DuraAce, 1));
            Assert.Equal(HtmlResultStatementOneDuraAce, order.HtmlReceipt(Data.Discounts).Replace(Environment.NewLine, ""));
        }
    }
}
